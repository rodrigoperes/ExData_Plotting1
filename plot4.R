...
## Convert "Global_active_power", "Sub_metering_1", "Sub_metering_2", 
## "Sub_metering_3", "Voltage" and "Global_reactive_power" fields into numeric 
## fields  
...
power_consumption$Voltage <- as.character(power_consumption$Voltage)
power_consumption$Voltage  <- as.numeric(power_consumption$Voltage)

power_consumption$Global_reactive_power <- as.character(power_consumption$Global_reactive_power)
power_consumption$Global_reactive_power <- as.numeric(power_consumption$Global_reactive_power)

## Part 2: Making Plots

## Open the PNG device, make the Plot 4 in the device and close the device
